...
int photo (void) {                      
  ...
  int pic     =  0;
	int KBD_but;
	unsigned char* images[] = {(unsigned char *)&CNTOWER_pixel_data, (unsigned char *)&CRAZYFROG_pixel_data, (unsigned char *)&ANGRYBIRD_pixel_data};
                ...
                case KBD_DOWN:
                    ...
                    break;
						...
						if(currentButtonState == KBD_LEFT | currentButtonState == KBD_RIGHT){
							...
							GLCD_Clear(White);
							GLCD_Bitmap(50, 50, 200, 200, images[pic]);
						}
