...
unsigned char* images[] = {(unsigned char *)&ACESPADE_pixel_data, (unsigned char *)&EIGHTSPADE_pixel_data, (unsigned char *)&FIVEHEART_pixel_data, (unsigned char *)&FOURHEART_pixel_data, (unsigned char *)&JACKHEART_pixel_data, (unsigned char *)&KINGCLUB_pixel_data, (unsigned char *)&NINEHEART_pixel_data, (unsigned char *)&QUEENDIAMOND_pixel_data, (unsigned char *)&SEVENCLUB_pixel_data, (unsigned char *)&SIXDIAMONDS_pixel_data, (unsigned char *)&TENSPADE_pixel_data, (unsigned char *)&THREESPADE_pixel_data, (unsigned char *)&TWODIAMOND_pixel_data};
				...
				if (KBD_But == KBD_SELECT) {
						...
						if (cardStates[selectedCardIndex] == CARD_BACK && flippedCardCount < 2) {
								...
								if (flippedCardCount == 2) {
										// Introduce a delay to allow players to see both cards
										delay(15000000); // Adjust the duration as needed
